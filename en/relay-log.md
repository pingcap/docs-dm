...
category: reference
aliases: ['/docs/dev/reference/tools/data-migration/relay-log/','/docs/v3.1/reference/tools/data-migration/relay-log/','/docs/stable/reference/tools/data-migration/relay-log/','/docs/v2.1/reference/tools/data-migration/relay-log/']
---
