...
- `subdir`:
    ...
    - After [a switch between primary and secondary instances](cluster-operations.md#switch-between-primary-and-secondary-instances) in the upstream, DM-worker generates a new `subdir` directory with an incremental serial number.
