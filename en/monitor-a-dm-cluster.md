...
| replicate lag histogram | The histogram of replicating the binlog from master to `syncer` (in seconds). Note that due to different statistical mechanisms, errors exist in the data | N/A | N/A |
