...
aliases: ['/docs/stable/how-to/deploy/data-migration-with-ansible/']
---
...
In addition, you need to meet the [hardware and software requirements](https://docs.pingcap.com/tidb-data-migration/stable/hardware-and-software-requirements) when deploy a DM cluster.
