...
| server_id | DM-worker connects to MySQL as a secondary library. This variable is the server ID of the secondary library. Keep it globally unique in the MySQL cluster, where the value range is 0 ~ 4294967295. In v1.0.2 and later versions, the server ID is automatically generated by DM. |
