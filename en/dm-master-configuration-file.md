...
| Name        | Description                                    |
| :------------ | :--------------------------------------- |
| `source-id` | Uniquely identifies a MySQL or MariaDB instance, or a migration group with the primary-secondary structure, which needs to be consistent with the `source-id` of DM-worker. |
