...
- If you need to change the [table routing](feature-overview.md#table-routing) rule, you have to wait for the migration of all sharding DDL statements to complete.
...
This section shows how DM migrates DDL statements in the process of merging sharded tables based on the above example in the [background](#background) section.
