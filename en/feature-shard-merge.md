...
category: reference
aliases: ['/docs/dev/reference/tools/data-migration/features/shard-merge/','/docs/v3.1/reference/tools/data-migration/features/shard-merge/','/docs/v3.0/reference/tools/data-migration/features/shard-merge/','/docs/v2.1/reference/tools/data-migration/features/shard-merge/']
---
...
- If you need to change the [table routing](feature-overview.md#table-routing) rule, you have to wait for the replication of all sharding DDL statements to complete.
...
![shard-ddl-example-1](/media/shard-ddl-example-1-en.png)
...
![shard-ddl-flow](/media/shard-ddl-flow-en.png)
...
- After being converted by the [table router](feature-overview.md#table-routing), the DDL statement of the upstream sharded tables must be consistent with the DDL statement to be executed in the downstream. Therefore, this DDL statement only needs to be executed once by the DDL owner and all other DM-workers can ignore this DDL statement.
...
![shard-ddl-example-2](/media/shard-ddl-example-2-en.png)
