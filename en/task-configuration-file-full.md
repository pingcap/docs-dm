...
shard-mode: "pessimistic"       # This needs to be configured if it is a shard merge task. Available modes are ""/"pessimistic"/"optimistic". The "" mode is used by default. If it's a shard merge task, please set to the "pessimistic" mode. After understanding the principles and restrictions of the "optimistic" mode, you can set to the "optimistic" mode.
