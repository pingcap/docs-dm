...
>- The deployment directories generated by some components are different from that of the original cluster. You can execute the `display` command to view the details. 
