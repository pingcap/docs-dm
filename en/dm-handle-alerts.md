<<<<<<< HEAD:en/dm-handle-alerts.md
---
title: Handle Alerts
summary: Understand how to deal with the alert information in DM.
aliases: ['/tidb-data-migration/dev/handle-alerts.md/,'/tidb-data-migration/dev/handle-alerts/']
---
...
- Solution:
    ...
    Refer to [Handle Performance Issues](dm-handle-performance-issues.md).
>>>>>>> parent of a030378 (rename_files):en/handle-alerts.md
