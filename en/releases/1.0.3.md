...
aliases: ['/docs/tidb-data-migration/stable/releases/1.0.3/','/docs/tidb-data-migration/v1.0/releases/1.0.3/','/docs/dev/reference/tools/data-migration/releases/1.0.3','/docs/v3.1/reference/tools/data-migration/releases/1.0.3','/docs/v3.0/reference/tools/data-migration/releases/1.0.3','/docs/v2.1/reference/tools/data-migration/releases/1.0.3','/docs/tidb-data-migration/stable/1.0.3/']
---
