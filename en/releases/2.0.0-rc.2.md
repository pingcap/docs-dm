...
- Fix the `field remove-meta not found in type config.TaskConfig` error that occurs when using the task configuration file of the v1.0.x cluster to start the task of v2.0 cluster [#965](https://github.com/pingcap/dm/pull/965)
