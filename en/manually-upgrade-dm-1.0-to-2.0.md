...
1. Use the [`operate-source`](manage-source.md#load-list-remove-the-data-source) command to load the upstream database source configuration from [step 1](#step-1-prepare-v20x-configuration-file) into the v2.0.x cluster.
