...
category: how-to
aliases: ['/docs/dev/how-to/migrate/from-aurora/','/docs/dev/how-to/migrate/from-mysql-aurora/','/docs/v3.1/how-to/migrate/from-mysql-aurora/','/docs/v3.0/how-to/migrate/from-mysql-aurora/','/docs/v2.1/how-to/migrate/from-mysql-aurora/']
---
