...
aliases: ['/tidb-data-migration/stable/task-configuration-guide/']
---
...
- To view the data source, you can refer to [Check the data source configuration](dm-manage-source.md#check-data-source-configurations).
- To create a data source, you can refer to [Create data source](migrate-data-using-dm.md#step-3-create-data-source).
- To generate a data source configuration file, you can refer to [Source configuration file introduction](dm-source-configuration-file.md).
...
1. Configure a global filter rule set of the block and allow list in the task configuration file.
    ...
    For detailed configuration rules, see [Block and allow table lists](dm-key-features.md#block-and-allow-table-lists).
...
1. Configure a global filter rule set of binlog events in the task configuration file.
    ...
    For detailed configuration rules, see [Binlog event filter](dm-key-features.md#binlog-event-filter).
...
1. Configure a global routing mapping rule set in the task configuration file.
    ...
    For detailed configuration rules, see [Table Routing](dm-key-features.md#table-routing).
