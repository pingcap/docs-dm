...
| `enable-relay` | Determines whether to enable the relay log feature. The default value is `false`. Since DM v2.0.2, this configuration item is deprecated. Please use `start-relay` command to enable relay. |
...
For description of relay log, see [Relay Log](relay-log.md).
