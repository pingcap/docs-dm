...
aliases: ['/tidb-data-migration/stable/key-features/']
---
...
> - Starting from DM v2.0.2, you can configure binlog event filters in the source configuration file. For details, see [Upstream Database Configuration File](dm-source-configuration-file.md).
