...
> - If you need to verify the function only, you can deploy a DM-master on a single machine. The number of DM-worker deployed is equivalent to the number of upstream MySQL instances at least. To ensure high availability, it is recommended to deploy more DM-workers.
