...
aliases: ['/docs-cn/tidb-data-migration/stable/releases/1.0.2/','/docs-cn/tidb-data-migration/v1.0/releases/1.0.2/','/docs-cn/dev/reference/tools/data-migration/releases/1.0.2','/docs-cn/v3.1/reference/tools/data-migration/releases/1.0.2','/docs-cn/v3.0/reference/tools/data-migration/releases/1.0.2','/docs-cn/v2.1/reference/tools/data-migration/releases/1.0.2','/docs-cn/tidb-data-migration/stable/1.0.2/','/docs-cn/stable/reference/tools/data-migration/releases/1.0.2/']
---
