...
aliases: ['/docs-cn/tidb-data-migration/stable/releases/1.0.5/','/docs-cn/tidb-data-migration/v1.0/releases/1.0.5/']
=======
aliases: ['/docs-cn/tidb-data-migration/dev/releases/1.0.5/']
