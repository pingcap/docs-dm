...
category: reference
aliases: ['/docs-cn/dev/faq/data-migration/','/docs-cn/dev/reference/tools/data-migration/faq/','/docs-cn/v3.1/reference/tools/data-migration/faq/','/docs-cn/stable/reference/tools/data-migration/faq/','/docs-cn/v2.1/reference/tools/data-migration/faq/']
---
