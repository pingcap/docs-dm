...
syncers:                             # sync 处理单元的运行配置参数
  global:                            # 配置名称
    ...
    # 如 DELETE FROM tb WHERE a=1; INSERT INTO tb(a,b) VALUES(1,1); 会被压缩成 INSERT INTO tb(a,b) VALUES(1,1); 其中 a 为主键
    compact: false
    # 设置为 true，DM 会尽可能的将多条同类型的语句合并到一条语句中，生成一条带多行数据的 SQL 语句。
