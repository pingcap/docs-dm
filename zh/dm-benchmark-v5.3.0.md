...
aliases: ['/zh/tidb-data-migration/stable/benchmark-v5.3.0/','/zh/tidb/stable/dm-benchmark-v5.3.0/']
---
...
可以参考[性能测试](dm-performance-test.md)中介绍的测试场景，测试单个 MySQL 实例到 TiDB 的数据迁移： MySQL1 (172.16.6.1) -> DM-worker(172.16.6.2) -> TiDB(load balance) (172.16.6.4)。

### 全量导入性能测试

可以参考[全量导入性能测试用例](dm-performance-test.md#全量导入性能测试用例)中介绍的方法进行测试。
...
使用[增量复制性能测试用例](dm-performance-test.md#增量复制性能测试用例)中介绍的方法进行测试。
