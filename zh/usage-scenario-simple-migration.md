...
- 为了满足[迁移要求](#迁移要求)中第一点的前三条要求，需要配置以下 [table routing 规则](feature-overview.md#table-routing)：
...
- 为了满足[迁移要求](#迁移要求)中第二点的第一条要求，需要配置以下 [table routing 规则](feature-overview.md#table-routing)：
...
- 为了满足[迁移要求](#迁移要求)中第一点的第四条要求，需要配置以下 [binlog event filter 规则](feature-overview.md#binlog-event-filter)：
...
- 为了满足[迁移要求](#迁移要求)中第二点的第二条要求，需要配置以下 [binlog event filter 规则](feature-overview.md#binlog-event-filter)：
...
- 为了满足[迁移要求](#迁移要求)中的第三点要求，需要配置以下 [block & Allow Table Lists 规则](feature-overview.md#block--allow-table-lists)：
