...
title: DM Portal 简介
category: reference
aliases: ['/docs-cn/dev/reference/tools/data-migration/dm-portal/','/docs-cn/v3.1/reference/tools/data-migration/dm-portal/','/docs-cn/stable/reference/tools/data-migration/dm-portal/','/docs-cn/v2.1/reference/tools/data-migration/dm-portal/']
---

# DM Portal 简介

当前版本的 DM 提供了丰富多样的功能特性，包括 [Table routing](feature-overview.md#table-routing)，[Black & white table lists](feature-overview.md#black--white-table-lists)，[Binlog event filter](feature-overview.md#binlog-event-filter) 等。但这些功能特性同时也增加了用户使用 DM 的复杂度，尤其在编写 [DM 任务配置](task-configuration-file.md)的时候。
